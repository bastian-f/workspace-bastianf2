# com-chilipeppr-workspace-bastianf2
A ChiliPeppr Workspace bastianf2.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / bastianf2
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-bastianf2 |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/bastian-f/workspace-bastianf2/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-bastianf2"], // the id you gave your workspace
      function(myWorkspaceBastianf2) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / bastianf2 just got loaded.", myWorkspaceBastianf2);
        myWorkspaceBastianf2.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-bastianf2"</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / bastianf2"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace bastianf2."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/bastian-f/workspace-bastianf2/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/bastianf/chillipeppr-test-2"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/bastian-f/workspace-bastianf2"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://chillipeppr-test-2-bastianf.c9users.io/workspace.html"</td></tr><tr valign="top"><td>foreignSubscribe</td><td>object</td><td>Please see docs above.</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td></td></tr><tr valign="top"><td>widgetSpjs</td><td>object</td><td></td></tr><tr valign="top"><td>init</td><td>function</td><td>function () </td></tr><tr valign="top"><td>getBillboard</td><td>function</td><td>function () </td></tr><tr valign="top"><td>addBillboardToWorkspaceMenu</td><td>function</td><td>function () </td></tr><tr valign="top"><td>setupResize</td><td>function</td><td>function () </td></tr><tr valign="top"><td>onResize</td><td>function</td><td>function () </td></tr><tr valign="top"><td>loadTemplateWidget</td><td>function</td><td>function (callback) </td></tr><tr valign="top"><td>loadSpjsWidget</td><td>function</td><td>function (callback) </td></tr><tr valign="top"><td>loadSenscapeBootloaderWidget</td><td>function</td><td>function (callback) </td></tr><tr valign="top"><td>loadWorkspaceMenu</td><td>function</td><td>function (callback) </td></tr>
      </tbody>
  </table>
